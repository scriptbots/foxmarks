...
var gFoxmarksUT = {
    status: function(s){
        ...
        os.notifyObservers(null, "foxmarks-unittest-status",
            s);
        LogWrite(s);
    },
    ...
    testList: [
        ...
        function(statusFunc, errorFunc, finishFunc){
            ...
            var ct = gSettings.getUnitTestOption(id);
            if(ct){
        ...
        function(statusFunc, errorFunc, finishFunc){
            ...
            if(ct){
                ...
                var username = gSettings.username;
                var password = gSettings.passwordNoPrompt;
                var pin = gSettings.pinNoPrompt;
                var mgr = Components.classes["@mozilla.org/login-manager;1"]
                    .getService(Components.interfaces.nsILoginManager);
                
                mgr.removeAllLogins();
                gSettings.username = username;
